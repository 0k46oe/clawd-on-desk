...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      rowFullscreenOverlayDesc: "Keep the pet on top of borderless-fullscreen apps and games (still draggable) instead of hiding below them. Windows only; exclusive-fullscreen games may not support it.",
      rowSize: "Size",
    ...
    zh: {
      ...
      rowFullscreenOverlayDesc: "让桌宠浮在无边框全屏应用/游戏上方（仍可拖动），而不是躲到下面。仅 Windows；独占全屏游戏可能不支持。",
      rowSize: "大小",
    ...
    "zh-TW": {
      ...
      rowFullscreenOverlayDesc: "讓桌寵浮在無邊框全螢幕應用程式／遊戲上方（仍可拖曳），而不是躲到下面。僅 Windows；獨佔全螢幕遊戲可能不支援。",
      rowSize: "大小",
    ...
    ko: {
      ...
      rowFullscreenOverlayDesc: "펫을 테두리 없는 전체화면 앱/게임 위에 유지합니다(드래그 가능). 아래로 숨기지 않습니다. Windows 전용이며 독점 전체화면 게임은 지원되지 않을 수 있습니다.",
      rowSize: "크기",
    ...
    ja: {
      ...
      rowFullscreenOverlayDesc: "ペットをボーダーレス全画面アプリ／ゲームの上に表示します（ドラッグ可能）。下に隠れません。Windows のみ。排他的全画面ゲームでは動作しない場合があります。",
      rowSize: "サイズ",
